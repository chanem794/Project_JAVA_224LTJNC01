...
public class PanelDataStation {
    private static final Color BORDER_COLOR = new Color(63, 171, 222); // Màu viền xanh đậm
    ...
    public static JPanel createStationPanel(String time, String station, String address) {
        ...
        radioButton.addActionListener(e -> {
            if (radioButton.isSelected()) {
                radioButton.setForeground(new Color(0x2196F3));
            } else {
                radioButton.setForeground(new Color(0x102102));
            }
        });
        ...
        radioButton.setBorder(BorderFactory.createEmptyBorder(2, 2, 2, 2));
