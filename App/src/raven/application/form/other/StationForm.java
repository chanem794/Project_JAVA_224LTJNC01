...
public class StationForm extends javax.swing.JPanel {
    ...
    private ConnectStationForm conn;
    ...
    public StationForm() {
        ...
        try {
            conn = new ConnectStationForm(this); // Khởi tạo một lần
    ...
    public void addRadioButtonListeners() {
        // Tạo mới ButtonGroup để đảm bảo trạng thái sạch
        pickupButtonGroup = new ButtonGroup();
        dropoffButtonGroup = new ButtonGroup();

        // Thêm sự kiện cho các JRadioButton trong roundedPanel6 (điểm đón)
    ...
    private void updateFare() {
        ...
        if (selectedPickupStation != null && selectedDropoffStation != null) {
            try {
                String result = conn.getprice(selectedPickupStation, selectedDropoffStation);
...
//    }
    ...
    private void jTextField1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTextField1ActionPerformed
        try {
            ConnectStationForm conn = new ConnectStationForm(this);
            conn.eventtextfield1();
        } catch (SQLException ex) {
            Logger.getLogger(StationForm.class.getName()).log(Level.SEVERE, null, ex);
        }
